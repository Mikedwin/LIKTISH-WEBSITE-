      ...
      <div className="container-shell">
        ...
        <div className="grid gap-8 lg:gap-10 xl:grid-cols-[0.94fr_1.06fr] xl:gap-12">
          ...
          <div>
              ...
              {whyLiktishPoints.map((point, index) => (
                ...
                >
                  <article
                    className={
                      index === 3
                        ? "group section-frame rounded-[1.35rem] p-5 transition duration-300 hover:-translate-y-1.5 hover:border-[#7ea893]/45 hover:bg-[linear-gradient(180deg,#f3f5ee_0%,#e7efe7_100%)] hover:shadow-[0_22px_52px_rgba(11,33,25,0.10)] sm:rounded-[1.55rem] sm:p-6 xl:ml-6"
                        : "group section-frame rounded-[1.35rem] p-5 transition duration-300 hover:-translate-y-1.5 hover:border-[#7ea893]/45 hover:bg-[linear-gradient(180deg,#f3f5ee_0%,#e7efe7_100%)] hover:shadow-[0_22px_52px_rgba(11,33,25,0.10)] sm:rounded-[1.55rem] sm:p-6"
                    }
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      <span
                        className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[0.9rem] border border-[#19A875]/16 bg-[#e7f7f0] text-[#19A875] transition duration-300 group-hover:-translate-y-1 group-hover:border-[#7ea893]/36 group-hover:bg-[#dfe8df] group-hover:text-[#21493a] sm:h-11 sm:w-11 sm:rounded-[1rem]"
                      >
                        {pointIcons[index]}
                      </span>
                      <div>
                        <h3 className="headline text-[1.45rem] font-black text-brand transition duration-300 group-hover:translate-x-1 group-hover:text-brand sm:text-2xl">
                          {point.title}
                        </h3>
            ...
            <RevealOnScroll delay={380} className="mt-6 sm:mt-8">
