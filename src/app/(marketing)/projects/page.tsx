        ...
        <section className="mt-16">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {projectLibrary.map((project) => (
              ...
              >
                <div className="relative mx-4 mt-4 h-56 overflow-hidden rounded-[1.5rem] sm:mx-5 sm:mt-5 sm:h-64">
                  <Image
                    src={project.image}
                    alt={project.title}
                    width={800}
                ...
                <div className="flex h-full flex-col px-6 pb-6 pt-8 sm:px-6 sm:pb-6 sm:pt-10">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-soft">
