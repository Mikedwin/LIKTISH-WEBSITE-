  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#cfe6d5_0%,#dcc199_100%)] px-4 py-16 sm:py-20">
      ...
      <div className="container-shell relative grid gap-8 xl:grid-cols-[0.82fr_1.18fr] xl:gap-10">
        ...
        <div className="relative overflow-hidden rounded-[1.7rem] border border-[#cddcd3] bg-[linear-gradient(145deg,#f8fcf9_0%,#eef6ef_42%,#f3e6cf_100%)] p-5 shadow-[0_30px_70px_rgba(11,33,25,0.1)] sm:rounded-[2rem] sm:p-8 lg:p-10">
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02))]" />
          <div className="absolute inset-y-0 right-0 w-[32%] bg-[linear-gradient(180deg,rgba(21,144,102,0.08),rgba(21,144,102,0.02))]" />
          <div className="absolute inset-y-0 left-0 w-[22%] bg-[linear-gradient(180deg,rgba(203,138,46,0.08),rgba(203,138,46,0.02))]" />
          <div className="absolute -right-8 top-10 h-36 w-36 rounded-full bg-[rgba(21,144,102,0.12)] blur-3xl" />
          <div className="absolute bottom-0 left-10 h-28 w-28 rounded-full bg-[rgba(203,138,46,0.12)] blur-3xl" />
