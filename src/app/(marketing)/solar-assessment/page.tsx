    ...
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#cfe6d5_0%,#dcc199_100%)] px-4 py-14 sm:py-20">
      ...
      <div className="container-shell relative grid gap-6 sm:gap-8 xl:grid-cols-[0.82fr_1.18fr] xl:gap-10">
        <div className="xl:sticky xl:top-28 xl:self-start">
          <p className="text-[0.82rem] font-semibold uppercase tracking-[0.18em] text-brand-soft sm:text-[1.05rem] sm:tracking-[0.22em]">
            Free Solar Assessment
          </p>
          <h1 className="headline mt-3 max-w-2xl text-[2.05rem] font-black leading-[0.94] text-brand sm:text-[3.2rem] md:text-[4rem]">
